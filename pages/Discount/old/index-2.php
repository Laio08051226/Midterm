          ...
          <table class="table">
              ...
              <tbody>
                  ...
                  <tr class="">
                      ...
                      <?=$jsonArray[$i]["event_name"]?>
                      </td>
                      <td class="text-center">  <!--#4  活動分類-->
                      <?=$jsonArray[$i]["event_category"]?>
                      </td>
                      <td class="text-center">  <!--#5   起始日期-->
                      <?=$jsonArray[$i]["event_start"]?>
                      </td>
                      <td class="text-center">  <!--#6   結束日期-->
                      <?=$jsonArray[$i]["event_end"]?>
                      </td>
                      <td class="project-state">    <!--#7  活動內容-->
                      <?=$jsonArray[$i]["event_content"]?>
                      </td> <!--#8  活動折扣碼-->
                      <td class="text-center">
                      <?=$jsonArray[$i]["discount"]?>
                      </td>
                      <td class="text-center">  <!--#9  活動折扣數-->
                      <?=$jsonArray[$i]["percent_off"]?>
                      </td>
                      <td class="text-center">  <!--#10  Remark-->
                      <?=$jsonArray[$i]["event_remark"]?>
                      </td>
