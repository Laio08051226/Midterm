                  ...
                  <tr class="">
                      <td class="project-actions text-left">  <!--#11-->
                        <form action="" method="">
                          ...
                          <button type="submit" class="btn btn-danger btn-md del_btn" id="del_btn_<?=$users[$i]["id"]?>">
          ...
          <div class="modal-body">
              <div class="container form-group">
                  <div class="row">
                      ...
                      <div class="col-md-9"><input class="form-control" type="text" name="event_name" id="event_name" disabled></div>
                      <div class="col-md-3 text-right" >
                          <label for="">促銷活動類別:</label>
                      </div>
                      <div class="col-md-9"><input class="form-control" type="text" name="event_category" id="event_category" disabled></div>
                      <!--start date-->
                      <div class="col-md-3 text-right" >
                          <label for="">活動開始時間:</label>
                      </div>
                      <div class="col-md-9"><input class="form-control" type="text" name="event_start" id="event_start" disabled></div>

                      <div class="col-md-3 text-right" >
                          <label for="">活動結束時間:</label>
                      </div>
                      <div class="col-md-9"><input class="form-control" type="text" name="event_end" id="event_end" disabled></div>
                      
                      <div class="col-md-3 text-right" >
                          <label for="">促銷內容:</label>
                      </div>
                      <div class="col-md-9"><input class="form-control" type="text" name="event_content" id="event_content" disabled></div>

                      <div class="col-md-3 text-right" >
                          <label for="">促銷活動碼:</label>
                      </div>
                      <div class="col-md-9"><input class="form-control" type="text" name="discount" id="discount" disabled></div>

                      <div class="col-md-3 text-right" >
                          <label for="">折扣數:</label>
                      </div>
                      <div class="col-md-9"><input class="form-control" type="text" name="percent_off" id="percent_off" disabled></div>

                      <div class="col-md-3 text-right" >
                          <label for="">其他注意事項:</label>
                      </div>
                      <div class="col-md-9"><input class="form-control" type="text" name="event_remark" id="event_remark" disabled></div>
                  </div>
                </div>
            </div>
            <div class="modal-footer">
