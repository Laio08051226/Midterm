            ...
            <div id="table-wrapper" class="card">
                <div class="card-header ">
                        <div class="float-left">
                            <a class="btn btn-sm bg-warning ">排序</a>
                        </div>

                        <div class="float-right"><a class="btn btn-danger btn-sm " name="" href="#">
                        ...
                        <form action="update_product.php" method="post" name="productEdit" id="productEdit" enctype="multipart/form-data">
                            ...
                            <div class="">
                                ...
                                <div class="modal-footer">
                                    <button id="addbtn" class="btn btn-block bg-primary" type="submit"
                                            href="delete_product.php">確定修改
                                    </button>
    ...
    function editProduct(id) {
        ...
        switch (a){
            ...
            case'出售':
                ...
                document.getElementById("order_method04").setAttribute("checked","true")
                break;
        }

        console.log(document.getElementById("order_method04").getAttribute("checked"));
    }
